...
| [`abbrupt`](docs/abbrupt/) | ABBRUPT trial info page (Amiodarone vs Beta Blockade for new-onset AF in ICU, ISRCTN59775011) — summary, video, screening criteria, trial links. Recruiting (confirmed via BCTU; ISRCTN registry entry appears stale). | https://swb-icu.github.io/research/abbrupt/ |
| [`abbrupt/eligibility-tool`](docs/abbrupt/eligibility-tool/) | ABBRUPT eligibility checker (Protocol V4.0, 20 Jan 2025) with auto-derived potassium exclusion check. | https://swb-icu.github.io/research/abbrupt/eligibility-tool/ |
| [`shorter`](docs/shorter/) | SHORTER trial info page (5-day fixed-course vs. standard-duration antibiotics for sepsis in critical care, ISRCTN40090372) — summary, video, screening criteria, trial links. | https://swb-icu.github.io/research/shorter/ |
| [`shorter/eligibility-tool`](docs/shorter/eligibility-tool/) | SHORTER eligibility checker (Protocol V4.0, 12 Mar 2024) with an antibiotic-day (1–4) check. | https://swb-icu.github.io/research/shorter/eligibility-tool/ |
